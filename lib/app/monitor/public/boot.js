...
},{"./template.jade":3,"angular":"angular"}],3:[function(require,module,exports){
...
pug_html = pug_html + "\u003Cdiv class=\"item\" ng-repeat=\"log in logs\"\u003E";
...
},{"./directives/log-monitor":2,"./modules/ansi":5,"./modules/rx-ext":7,"./services/cmd":8,"./services/data":9,"./services/socket":10,"./states":19,"angular":"angular","angular-moment":"angular-moment","angular-ui-router":"angular-ui-router","rx-angular":"rx-angular"}],5:[function(require,module,exports){
'use strict';
...
},{"./lib/ansi2html":6,"angular":"angular"}],6:[function(require,module,exports){
...
},{"angular":"angular","rx-angular":"rx-angular"}],8:[function(require,module,exports){
'use strict';
...
},{"angular":"angular","rx-angular":"rx-angular"}],10:[function(require,module,exports){
'use strict';
...
},{"angular":"angular","socket.io-client":"socket.io-client"}],11:[function(require,module,exports){
'use strict';
...
},{"./template.pug":12}],12:[function(require,module,exports){
...
},{"./template.pug":14}],14:[function(require,module,exports){
...
pug_html = pug_html + "\u003Cbutton class=\"restart\" ng-click=\"$cmd.exec('restart', { image: image.id })\"\u003E";
...
pug_html = pug_html + "\u003Cbutton class=\"start\" ng-click=\"$cmd.exec('start', { image: image.id })\"\u003E";
...
pug_html = pug_html + "\u003Cbutton class=\"stop\" ng-click=\"$cmd.exec('stop', { image: image.id })\"\u003E";
...
pug_html = pug_html + "\u003Cdiv class=\"fa fa-stop\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fheader\u003E";
...
;pug_debug_line = 26;pug_debug_filename = "\u002FUsers\u002Fplati\u002Fgithub\u002Fnode-compose\u002Flib\u002Fapp\u002Fmonitor\u002Fsrc\u002Fapp\u002Fstates\u002Fapp.images.image\u002Ftemplate.pug";
...
;pug_debug_line = 5;pug_debug_filename = "\u002FUsers\u002Fplati\u002Fgithub\u002Fnode-compose\u002Flib\u002Fapp\u002Fmonitor\u002Fsrc\u002Fapp\u002Fstates\u002Fapp.images\u002Ftemplate.pug";
pug_html = pug_html + "{{ iamge.status }}\u003C\u002Fdiv\u003E\u003C\u002Fli\u003E\u003C\u002Faside\u003E";
...
pug_html = pug_html + "\u003Cmain class=\"ui-view\"\u003E\u003C\u002Fmain\u003E\u003C\u002Fdiv\u003E";} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;};;
module.exports = template();
...
},{"./app":17,"./app.dashboard":11,"./app.images":15,"./app.images.image":13,"angular":"angular"}],20:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./app":4,"angular":"angular","css-element-queries/src/ElementQueries":"css-element-queries/src/ElementQueries","jquery":"jquery"}]},{},[20]);
