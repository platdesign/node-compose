...
class Process {
	...
	_setState(state) {
		...
		this._log(['log', '#verbose'], `State: ${state}`);
	}
	...
	start() {
		...
		if(this.getState() !== 'idle') {
			return Promise.reject( new Error('Not idle', STATE_CODES[this.getState()]) );
		}
	...
	stop() {
		...
		if(this.getState() !== 'running') {
			return Promise.reject( new Error('Not running', STATE_CODES[this.getState()]) );
		}
